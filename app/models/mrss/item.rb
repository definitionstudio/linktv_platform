module Mrss
  ...
  require "mrss/media_group.rb"
	...
	class Item
		...
		element :'media:copyright_url', :value => :url, :as => :media_copyright_url
		element :'media:license', :as => :media_license
		element :'media:license_href', :value => :href, :as => :media_license_href
		...
		element :'media:content', :as => :media_content, :class => MediaContent
